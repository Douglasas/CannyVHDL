...
for i in tqdm(range(QT_IMGS_CANNY)):
    ...
    sum_lp    += measure.compare_ssim(img_canny, hw_lp[1:-1,1:-1])
    ...
    sum_robs  += measure.compare_ssim(img_canny, hw_robs[1:-2,1:-2])
    ...
    sum_prew  += measure.compare_ssim(img_canny, hw_prew[1:-1,1:-1])
    ...
    sum_sob   += measure.compare_ssim(img_canny, hw_sob[1:-1,1:-1])
...
print("AVG SSIM laplacian", sum_lp    / QT_IMGS_CANNY)
print("AVG SSIM roberts",   sum_robs  / QT_IMGS_CANNY)
print("AVG SSIM prewitt",   sum_prew  / QT_IMGS_CANNY)
print("AVG SSIM sobel",     sum_sob   / QT_IMGS_CANNY)
